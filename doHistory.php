...
$searchName = $_POST["date"];
        ...
        $query = "SELECT * FROM historyy WHERE plot_number = '$country'&& type_vegetable = '$type' && date= '$searchName'";
        ...
        <br></br>
        <a href="index.php">
     <input type="submit" value ="temperature bargraph"/>
   </a>
