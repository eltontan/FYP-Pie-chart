                                                ...
                                                <div class="card-header trans_float"> 
                                                    ...
                                                    <div class="lead" id="loc_aa1"><div class="imgwrapper"><img src="images/<?php
                                                        ...
                                                        <ul class="list-group list-group-flush trans_float">
                                                            <li class="list-group-item trans_float"><i class=" fas fa-temperature-high"></i> <?php echo $row[5]; ?>C(temperature)</li>
                                                            <li class="list-group-item trans_float"><i class=" fas fa-water"></i> <?php echo $row[6]; ?>%(Humidity)</li>
                                                            <li class="list-group-item trans_float"><i class=" fas fa-syringe"></i> <?php echo $row[7]; ?>(soil status)</li>
                                                            <li class="list-group-item trans_float"><i class=" fas fa-syringe"></i> <?php echo $row[8]; ?>%(disease)</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
